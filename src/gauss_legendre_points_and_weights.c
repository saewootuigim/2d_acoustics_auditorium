...
void legendre_points_and_weights ( int n, double a, double b, double *xi, double *wi );
...
/*
  Purpose:
    ...
    legendre_points_and_weights computes the requested Gauss-Legendre rule and outputs it.
...
*/
  legendre_compute_glr ( n, xi, wi );

  /*
  Rescale the rule to [A,B].
*/
  if( fabs(a-xi[0])<.001 && fabs(b-xi[n-1])<.001 )
	rescale ( a, b, n, xi, wi );
}
/******************************************************************************/
